...
$(EXECUTABLE): $(BUILD_DIR)/a11_main.o $(BUILD_DIR)/a11_pset.o $(BUILD_DIR)/basicImageManipulation.o $(BUILD_DIR)/filtering.o $(BUILD_DIR)/Image.o $(BUILD_DIR)/lodepng.o
	$(CXX) $(BUILD_DIR)/a11_main.o $(BUILD_DIR)/a11_pset.o $(BUILD_DIR)/basicImageManipulation.o $(BUILD_DIR)/filtering.o $(BUILD_DIR)/Image.o $(BUILD_DIR)/lodepng.o -o $(EXECUTABLE)
	mkdir -p $(OUTPUT)
...
$(BUILD_DIR)/a11_main.o: a11_main.cpp filtering.h basicImageManipulation.h Image.h ImageException.h  lodepng.h messageassert.h matrix.h a11_pset.h 
	mkdir -p $(BUILD_DIR)
	$(CXX) -c a11_main.cpp -o $(BUILD_DIR)/a11_main.o

$(BUILD_DIR)/a11_pset.o: a11_pset.cpp a11_pset.h filtering.h basicImageManipulation.h Image.h ImageException.h  lodepng.h messageassert.h matrix.h
	mkdir -p $(BUILD_DIR)
	$(CXX) -c a11_pset.cpp -o $(BUILD_DIR)/a11_pset.o
